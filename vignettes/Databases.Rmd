...
For additional information on database configuration, consult the [onboarding guide](http://mtapshiny1p/MT/Strategic_Initiatives/Onboarding/rodbc.html) from our friends over in Metro Transit Strategic Initiatves. You must be on the Council network to access the guide.
